...
import sys
sys.path.append("F:/5.Github项目代码/11.Python深度学习/chapter8/data/ensemble/source_file")  # 添加项目根路径，避免在服务器上调用代码时找不到上一级目录的模块
...
if __name__ == '__main__':
    ...
    remove_list = [
        ...
        'dev_result_detail_model_0.5720_0.4779-8012.txt',
        'dev_result_detail_model_0.5296_0.6694-4006.txt', ]
    # 测试集
